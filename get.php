...
<div class="container-fluid">
    ...
    <div class="col-md-3 column">
            ...
            <form id="elform" method="POST" action="get_test.php" enctype="multipart/form-data" class="form-horizontal"> 
              ...
              <input type="text" class="form-control" id="URL" placeholder="url base" name="URL" value="http://172.16.11.152/customerRest/web/customer/get/" />
              <div class="input-group-btn">
              <input class="btn btn-primary metodo" method="GET" value="GET" name="post" name="tipoTransaccion" id="tipoTransaccion" disabled>
							</div>
					    </div>
