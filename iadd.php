...
<input class="form-control" id="lastBillingDate" placeholder="lastBillingDate" name="lastBillingDate"required>
</div>  

<div class="input-group input-group-sm imputadjust">
<span class="input-group-addon ">ChangePassword</span>
<input class="form-control" id="changePassword" placeholder="changePassword" name="changePassword" required>
</div>  

<div class="input-group input-group-sm imputadjust">
<span class="input-group-addon ">Lastlogin</span>
<input class="form-control" type="text" id="lastlogin" placeholder="lastlogin" name="lastlogin" required>
</div>  
