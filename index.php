    ...
    <div class="col-md-3 column">
            ...
            <form id="elform" method="POST" action="get_test.php" enctype="multipart/form-data" class="form-horizontal"> 
              ...
              <div class="input-group input-group-sm baseurl">
							<input type="text" class="form-control" id="URL" placeholder="url base" name="URL" value="http://172.16.60.27/platformModules/CustomerService/web/customer/add/" />
          ...
          <div class="input-group">
          <span class="input-group-addon requerido"><i class="glyphicon glyphicon-exclamation-sign "></i></span>
          <input class="form-control" type="text" id="name" placeholder="name" name="name" value="prueba0">
          </div></div>
