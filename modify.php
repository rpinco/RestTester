...
<nav class="navbar navbar-default" role="navigation" style="margin-bottom: 0;">
  ...
  <div class="collapse navbar-collapse navbar-bootsnipp-collapse">
    <ul class="nav navbar-nav">
     ...
     <li class="active"><a href="modify.php"><span class="glyphicon glyphicon-pencil"></span> Modify</a></li>
...
<div class="container-fluid">
    ...
    <div class="col-md-3 column">
                ...
                <h2 class="Titulo">Modify Customer</h2>
            ...
            <form id="elform" method="POST" action="get_test.php" enctype="multipart/form-data" class="form-horizontal"> 
              ...
              <input type="text" class="form-control" id="URL" placeholder="url base" name="URL" value="http://172.16.60.27/platformModules/CustomerService/web/customer/modify/" />
          ...
          <input class="form-control" type="text" id="password" placeholder="password" name="password" value="">
          </div></div>
